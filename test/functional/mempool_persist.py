...
By default, sphinxcoind will dump mempool on shutdown and
...
class MempoolPersistTest(SphinxcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give sphinxcoind a second to reload the mempool
        ...
        self.log.debug("Prevent sphinxcoind from writing mempool.dat to disk. Verify that `savemempool` fails")

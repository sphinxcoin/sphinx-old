...
# TestNode: A peer we use to send messages to sphinxcoind, and store responses.
...
class CompactBlocksTest(SphinxcoinTestFramework):
    ...
    # This test actually causes sphinxcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that sphinxcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for sphinxcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # sphinxcoind will not send blocktxn responses for blocks whose height is

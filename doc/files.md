...
* sphinxcoin.conf: contains configuration settings for sphinxcoind or sphinxcoin-qt
* sphinxcoind.pid: stores the process id of sphinxcoind while running
...
* debug.log: contains debug information and general logging generated by sphinxcoind or sphinxcoin-qt

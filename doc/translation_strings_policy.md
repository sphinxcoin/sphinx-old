...
This document provides guidelines for internationalization of the Sphinxcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sphinxcoin_en.ts` remains unchanged.

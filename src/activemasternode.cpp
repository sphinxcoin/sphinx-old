...
// Copyright (c) 2017 Empinel / The SPHX Developers
...
//
// Bootup the masternode, look for a 5000 SPHX input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* donations are not supported in sphinxcoin.conf */
...
{
    CSphinxcoinAddress address(collateralAddress);

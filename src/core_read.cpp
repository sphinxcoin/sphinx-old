...
bool DecodeHexTx(CMutableTransaction& tx, const std::string& strHexTx, bool fTryNoWitness)
{
    ...
    if (fTryNoWitness) {
// SERIALIZE_TRANSACTSPHX_NO_WITNESS is to be defined in transaction.h
//        CDataStream ssData(txData, SER_NETWORK, PROTOCOL_VERSION | SERIALIZE_TRANSACTSPHX_NO_WITNESS);

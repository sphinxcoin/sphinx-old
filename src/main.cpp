...
const string strMessageMagic = "Sphinxcoin Signed Message:\n";
                        ...
                        bool* pfMissingInputs, bool fRejectInsaneFee, bool ignoreFees)
{
    ...
    // sphinxcoin: coinstake is also only valid in a block, not as a loose transaction
    if (tx.IsCoinStake())
...
// sphinxcoin: find block wanted by given orphan block
...
// sphinxcoin: find last block index up to pindex
...
bool ProcessBlock(CNode* pfrom, CBlock* pblock)
{
    ...
    // sphinxcoin: check proof-of-stake
    ...
    if (!mapBlockIndex.count(pblock->hashPrevBlock))
    {
        ...
        if (pfrom) {
            ...
            // sphinxcoin: getblocks may not obtain the ancestor block rejected
...
{
    RenameThread("sphinxcoin-loadblk");

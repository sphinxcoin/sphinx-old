...
#ifndef SPHX_PRIMITIVES_BLOCK_H
#define SPHX_PRIMITIVES_BLOCK_H
...
public:
    ...
    // sphinxcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // sphinxcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // sphinxcoin: get max transaction timestamp

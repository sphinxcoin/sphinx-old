...
/** Sphinxcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SphinxcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SphinxcoinUnits(QObject *parent);
...
typedef SphinxcoinUnits::Unit SphinxcoinUnit;

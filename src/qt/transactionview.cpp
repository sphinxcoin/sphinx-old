...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so SphinxcoinUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(SphinxcoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(SphinxcoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(SphinxcoinUnits::formatWithUnit(nDisplayUnit, amount, true, SphinxcoinUnits::separatorAlways));
